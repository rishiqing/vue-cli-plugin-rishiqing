...
/**
 * 打开付费详情页面
 * @param {string} buyType 想要购买的版本类型(ZY: 高级版, QY: 高级版, QJ: 旗舰版), 不区分大小写.如果不传buyType，则默认为续费操作
 */
...
/**
 * 打开通讯录邀请
 * @param {string} type 打开的邀请类型，(add: 添加成员弹窗，包含直接和批量邀请; invite: 邀请成员弹窗，包含链接邀请,团队码邀请以及二维码邀请),不传type则默认为add，即默认打开添加成员弹窗
 */
